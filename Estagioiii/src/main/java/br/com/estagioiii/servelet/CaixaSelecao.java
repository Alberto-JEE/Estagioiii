...
@WebServlet(name = "CaixaSelecao", urlPatterns = {"/Selecao"})
public class CaixaSelecao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!("").equalsIgnoreCase(request.getParameter("tende"))) {
            ...
            questionarioModel.setTipoQuestionarioModel(TipoQuestionarioDao.tipoQuestionario(4));
