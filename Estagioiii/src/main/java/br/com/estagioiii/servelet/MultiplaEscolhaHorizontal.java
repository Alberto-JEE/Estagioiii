...
public class MultiplaEscolhaHorizontal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       if (!("").equalsIgnoreCase(request.getParameter("tende"))) {
            ...
            questionarioModel.setPergunta(request.getParameter("textfiel"));
            questionarioModel.setTipoQuestionarioModel(TipoQuestionarioDao.tipoQuestionario(5));
            ...
            if (PerguntasDao.insereQuestionario(questionarioModel)) {
                ...
                for (int i = 0; i <= Integer.parseInt(request.getParameter("tende")); i++) {
                    if (request.getParameter("textfield" + i) != null) {
                        AlternativaModel alternativaModel = new AlternativaModel();
                        alternativaModel.setAlternativa(request.getParameter("textfield" + i));
