...
<html>
    ...
    <body>  
        <div class="wrapper">
            <div class="container">  
                <form id="formulario" name="formulario" method="post" action="Multipla"  onsubmit="return validarMultipla()" >  
                    <h1 style = "text-align:center" >Multipla Escolha</h1>
                    <br />
                    <%
                    ...
                    <% } %>
                    <p>
                        <input type="button" name="buttonsm" id="buttonsm" style="color: #1E90FF; float:right" value="+" onclick="adicionar(id)" />
                    ...
                    <div  id="aqui<%= +i%>">
                        <p>&nbsp; &nbsp;<%= i + 1%>
                            ...
                            <input type="text" name="textfield<%= +i%>" id="textfield<%= +i%>" size="100" />
                            <input type="button" name="buttons<%= +i%>" id="buttons<%= +i%>" style="color: #FF0000 " value="X" onclick="remover(id)" /> 
                        </p>
                    </div>
                    <%
                        }
