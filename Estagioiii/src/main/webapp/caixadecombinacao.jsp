...
<html>
    ...
    <body>
        <div class="wrapper">
            <div class="container">  
                <form id="formulario" name="formulario" method="post" action="Caixa"  onsubmit="return validarCombinacao()"> 
                    <h1 style = "text-align:center" >Única Aternativa</h1>
                    <br />
                    <% 
                    ...
                    <br /> <br /> 
                    <% } %>
                    <input type="button" name="buttonsm" id="buttonsm" style="color: #1E90FF; float:right" value="+" onclick="adicionarCaixa(id)" />
                    ...
                    <div  id="aqui<%= +i%>">
                        <p>&nbsp; &nbsp;<%= i + 1%>
                            <input type="radio" name="RadioGrup" id="RadioGroup"  />
                            <input type="text" name="text<%= +i%>" id="text<%= +i%>" size="100" />  
                            <input type="button" name="buttonsc<%= +i%>" id="buttonsc<%= +i%>" style="color: #FF0000 " value="X"  onclick="removerCaixa(id)"/> 
                        </p>                    
                    </div>
                    <%
                        }
